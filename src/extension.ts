...
=================================`);
  ...
  let codeCompletionDisposable = vscode.languages.registerCompletionItemProvider(
    sel,
    new PuzzleScriptCompletionItemProvider(),
    ""
  );
  ...
  context.subscriptions.push(
    vscode.commands.registerCommand("puzzlescript.gamePreview", () => {
      gp.createOrShow(context.extensionUri);
    })
  );

  context.subscriptions.push(
    vscode.commands.registerCommand("puzzlescript.toggleGamePreview", () => {
      gp.createOrShow(context.extensionUri);
    })
  );
  ...
  context.subscriptions.push(
    vscode.commands.registerCommand("puzzlescript.levelEditor", () => {
      le.createOrShow(context.extensionUri);
    })
  );

  context.subscriptions.push(
    vscode.commands.registerCommand("puzzlescript.toggleLevelEditor", () => {
      le.createOrShow(context.extensionUri);
    })
  );
